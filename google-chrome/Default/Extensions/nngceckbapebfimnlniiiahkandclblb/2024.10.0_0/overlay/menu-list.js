...
class AutofillInlineMenuList extends AutofillInlineMenuPageElement {
    constructor() {
         ...
         */
        this.updateCiphersListOnScroll = () => {
    ...
    setupCipherListScrollListeners() {
        ...
        if (this.showPasskeysLabels) {
            this.ciphersList.addEventListener(EVENTS.SCROLL, this.useEventHandlersMemo(throttle(() => this.updatePasskeysHeadingsOnScroll(this.ciphersList.scrollTop), 50), UPDATE_PASSKEYS_HEADINGS_ON_SCROLL), options);
        }
    }
    /**
